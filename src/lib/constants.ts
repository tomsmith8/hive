...
export const RESERVED_WORKSPACE_SLUGS = [
  ...
  'signup', 'register', 'signin', 'signout', 'onboarding',
  
  // Help & Support
  'help', 'support', 'docs', 'documentation', 'faq', 'contact',
  
  // Infrastructure
  'www', 'mail', 'email', 'blog', 'news', 'status', 'health',
  'graphql', 'webhook', 'callback', 'oauth', 'cdn', 'assets', 
  'static', 'public', 'private', 'uploads', 'downloads',
  
  // Environment
  'test', 'testing', 'staging', 'stage', 'prod', 'production',
  'dev', 'development', 'preview', 'demo',
  
  // App-specific routes
  'workspaces', 'workspace', 'user', 'users', 'profile', 'account',
  'billing', 'subscription', 'pricing', 'features', 'roadmap',
  'tasks', 'projects', 'repositories', 'repos', 'code-graph',
  'stakgraph', 'swarm', 'pool-manager',
  
  // Common conflicts
  'app', 'web', 'site', 'home', 'index', 'main', 'root',
  'about', 'terms', 'privacy', 'legal', 'security',
  
  // Technical
  'robots', 'sitemap', 'manifest', 'favicon', 'sw',
] as const;
...
export const WORKSPACE_ERRORS = {
  ...
  SLUG_INVALID_FORMAT: 'Workspace name must start and end with letters or numbers, and can only contain letters, numbers, and hyphens.',
