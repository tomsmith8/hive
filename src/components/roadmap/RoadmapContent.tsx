      ...
      userStories: [
        {
          ...
          soThat: "I can access the platform quickly without creating new credentials",
          acceptanceCriteria: [
      ...
      requirements: [
        {
          ...
          description: "Implement OAuth 2.0 flow for third-party authentication",
          type: "functional",
          priority: "high",
          status: "approved",
          acceptanceCriteria: ["OAuth flow redirects properly", "User credentials are secure"]
        }
      ],
      createdAt: new Date(),
      updatedAt: new Date()
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{statusCounts["planning"] || 0}</div>
            <p className="text-xs text-muted-foreground">
              In design phase
            </p>
          </CardContent>
