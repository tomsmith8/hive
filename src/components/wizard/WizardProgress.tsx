  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="hidden sm:flex items-center justify-center">
        {showStartEllipsis && (
          <>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${getStepStyle(false, true)}`}>
              ...
              {idx < visibleSteps.length - 1 && (
                <div
                  className={`w-8 h-0.5 mx-2 ${
                    currentStepIndex > stepIndex ? "bg-green-600" : "bg-gray-200"
                  }`}
                />
              )}
            </div>
