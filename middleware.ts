...
import { RESERVED_WORKSPACE_SLUGS, WORKSPACE_SLUG_PATTERNS } from "@/lib/constants";
...
export default withAuth(
  async function middleware(req) {
    ...
    if (
      ...
      (firstSegment && RESERVED_WORKSPACE_SLUGS.includes(firstSegment as typeof RESERVED_WORKSPACE_SLUGS[number]))
    ) {
  ...
  },
  {
    callbacks: {
      authorized: ({ token, req }) => {
        ...
        if (firstSegment && RESERVED_WORKSPACE_SLUGS.includes(firstSegment as typeof RESERVED_WORKSPACE_SLUGS[number])) {
